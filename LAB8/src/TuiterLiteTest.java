...
//
    ...
    @Test
    public void testarTextoOuUsuarioNuloException() throws IllegalArgumentException, UsuarioDesconhecidoException {
        assertNull(tuiterLite.tuitarAlgo(usuario,null));
        assertNull(tuiterLite.tuitarAlgo(null,"um tweet bem legal q eu fiz"));
    }

    @Test
    public void testarTamanhoMinimoException() throws TamanhoMinimoException, UsuarioDesconhecidoException {
        assertNull(tuiterLite.tuitarAlgo(usuario,""));
    }
}